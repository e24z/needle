...
REPAIR_ENV_NAMES = ("NEEDLE_REPAIR",)
MLX_PROFILE_ENV_NAMES = ("NEEDLE_MLX_PROFILE",)
MAX_LENGTH_ENV_NAMES = ("NEEDLE_MLX_MAX_LENGTH", "NEEDLE_MAX_LENGTH")
MLX_LIGHT_ENV_NAMES = ("NEEDLE_MLX_LIGHT",)
PROFILE_MLX_ENV_NAMES = ("NEEDLE_PROFILE_MLX",)
CHUNK_OVERLAP_ENV_NAMES = ("NEEDLE_CHUNK_OVERLAP_TOKENS",)
MAX_BATCH_SIZE_ENV_NAMES = ("NEEDLE_MLX_MAX_BATCH_SIZE",)
MAX_BATCH_TOKENS_ENV_NAMES = ("NEEDLE_MLX_MAX_BATCH_TOKENS",)
MAX_LENGTH_RATIO_ENV_NAMES = ("NEEDLE_MLX_MAX_LENGTH_RATIO",)
MLX_CACHE_LIMIT_ENV_NAMES = ("NEEDLE_MLX_CACHE_LIMIT_MB",)
MLX_WIRED_LIMIT_ENV_NAMES = ("NEEDLE_MLX_WIRED_LIMIT_MB",)
MLX_CLEAR_CACHE_ENV_NAMES = (
    "NEEDLE_MLX_CLEAR_CACHE_AFTER_PRUNE",
)
THRESHOLD_ENV_NAMES = ("NEEDLE_THRESHOLD",)
